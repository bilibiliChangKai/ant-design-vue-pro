export default {
  ...
  'user.login.username.placeholder': '手机号',
  ...
  'user.login.tab-login-mobile': '手机验证码登录',
  ...
  'user.login.login': '登录',
  'user.reset.resetpassword': '重置密码',
  'user.register.register': '注册',
  'user.register.email.placeholder': '电话号码',
  'user.register.password.placeholder': '请至少输入 8 个字符，必须包含字母和数字。请不要使用容易被猜到的密码。',
  'user.register.password.popover-message': '请至少输入 8 个字符，必须包含字母和数字。请不要使用容易被猜到的密码。',
  ...
  'user.password.strength.short': '不满足要求',
